...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'fuel.count', 'reminder.count', 'vehicle.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('fuel', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'fuel',
          header: 'Fuel',
          accessorKey: 'fuel',
          cell: ({ row: { original: record } }: any) => record?._count?.fuel,
        }
      : null,
