...
import { getLoadingSlipById } from 'apiSdk/loading-slips';
import { LoadingSlipInterface } from 'interfaces/loading-slip';

function LoadingSlipViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('loading_slip', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/loading-slips/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Slip Info" text={data?.slip_info} />
