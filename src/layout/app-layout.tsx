...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'logistics-manager', 'transporter', 'supplier', 'driver'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'E Bills', path: '/e-bills', entity: 'e_bill', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    { name: 'Fuels', path: '/fuels', entity: 'fuel', service: AccessServiceEnum.PROJECT, icon: FiZap },
    {
      name: 'Loading Slips',
      path: '/loading-slips',
      entity: 'loading_slip',
    ...
    { name: 'Services', path: '/services', entity: 'service', service: AccessServiceEnum.PROJECT, icon: FiTool },
    { name: 'Supplies', path: '/supplies', entity: 'supply', service: AccessServiceEnum.PROJECT, icon: FiPackage },
    { name: 'Trips', path: '/trips', entity: 'trip', service: AccessServiceEnum.PROJECT, icon: FiMap },
